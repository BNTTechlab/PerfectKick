...
public class GestureDetector : IDisposable
{
    ...
    private readonly string leanDB = "GestureDB\\KickGesture.gbd";


    /// <summary> Name of the discrete gesture in the database that we want to track </summary>
    private readonly string leanLeftGestureName = "Kick_Left";
    private readonly string leanRightGestureName = "Kick_Right";
